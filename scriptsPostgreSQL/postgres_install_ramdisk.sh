...
#$2: folder for the ramdisk
#$3: size for the RAMDisk (e.g: 64G)
#$4: your account's username
...
sudo mkdir -p $2
sudo mount -t tmpfs -o size=$3 tmpfs $2
sudo ./configure --prefix=$2/pgsql
sudo make
sudo make install
sudo chown $4 $2/pgsql
mkdir -p $2/pgsql/data
sudo chown $4 $2/pgsql/data
